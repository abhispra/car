...
class PinSet:
    ...
    def get_pin1_val(self):
        return self._pin1_val.get_pin_value()

    def get_pin2_val(self):
        return self._pin2_val.get_pin_value()

    def get_all(self):
        return self._enable.get_pin_value(), self._pin1_val.get_pin_value(), \
               self._pin2_val.get_pin_value()
